...
class _VolunteerPageState extends State<VolunteerPage> {
  ...
  Future<void> fetchVolunteerDetails() async {
    final Uri url = Uri.https('distractive-researc.000webhostapp.com', 'fetch_events.php');
  ...
  Future<void> volunteerForEvent(String eventId, String eventName) async {
    final Uri url = Uri.https('distractive-researc.000webhostapp.com', 'create_volunteer.php');
  ...
  Future<void> removeEvent(String eventId) async {
    final Uri url = Uri.https('distractive-researc.000webhostapp.com', 'delete_event.php');
